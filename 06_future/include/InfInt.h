...
inline void
InfInt::optimizeSqrtSearchBounds(InfInt &lo,
                                 InfInt &hi) const { // PROFILED_SCOPE
  InfInt hdn = one;
...
inline void InfInt::correct(bool justCheckLeadingZeros,
                            bool hasValidSign) { // PROFILED_SCOPE
...
inline ELEM_TYPE InfInt::dInR(const InfInt &R,
                              const InfInt &D) { // PROFILED_SCOPE
...
inline void
InfInt::multiplyByDigit(ELEM_TYPE factor,
